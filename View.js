...
segmentPaths = {
  ...
  'straight': [
    "M1125,690l1240,0l84,94l-7,62l-104,94l-1240,0l-84,-94l7,-62 Z",
    "M2404,1015l-113,1030l84,94l62,0l104,-94l113,-1030l-84,-94l-62,0 Z",
    "M2356,1002l-41,372l-696,683l41,-372 Z",
    "M1421,1128l-100,918l84,94l62,0l104,-94l100,-918l-84,-94l-62,0 Z",
    "M1066,1002l-55,501l258,554l55,-501 Z",
    "M764,1015l-113,1030l84,94l62,0l104,-94l113,-1030l-84,-94l-62,0 Z",
    "M1646,2120l563,0l84,94l-7,62l-104,94l-563,0l-84,-94l7,-62 Z",
    "M969,2120l260,0l84,94l-7,62l-104,94l-260,0l-84,-94l7,-62 Z",
    "M2248,2445l-113,1030l84,94l62,0l104,-94l113,-1030l-84,-94l-62,0 Z",
    "M1578,2432l-41,372l546,683l41,-372 Z",
    "M1277,2445l-100,918l84,94l62,0l104,-94l100,-918l-84,-94l-62,0 Z",
    "M1228,2432l-55,501l-379,554l55,-501 Z",
    "M608,2445l-113,1030l84,94l62,0l104,-94l113,-1030l-84,-94l-62,0 Z",
    "M812,3550l1240,0l84,94l-7,62l-104,94l-1240,0l-84,-94l7,-62 Z",
    "M2650,3390l83,0l74,83l-26,233l-92,83l-83,0l-74,-83l26,-233 Z",
    "M524,4435l1680,0l53,60l-14,130l-67,60l-1680,0l-53,-60l14,-130 Z",
  ],
};
charWidth = 342;
charHeight = 572;
...
class Connector {
  ...
  populateFullView(hasSeq, isSd1, isSd132) {
    ...
    this.addUse("L_B_volume", 120, 96.87737);
    this.addUse("L_B_data_entry", 167.5, 96.87737);
    ...
    this.addButton(235, 82, 15.8, 10, 52, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 15));
    if (isSd1) {
      this.addUse("B_bankset", 235, 96.87737);
    } else { // not isSd1
      this.addUse("B_cart", 235, 96.87737);
    }
    this.addButton(250.8, 82, 15.8, 10, 53, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 13));
    this.addUse("B_sounds", 250.8, 96.87737);
    this.addButton(266.6, 82, 15.8, 10, 54, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 7));
    this.addUse("B_presets", 266.6, 96.87737);
    if (hasSeq) {
      this.addButton(282.4, 82, 15.8, 10, 51, Colors.BUTTON_LIGHT);
      this.addUse("B_seq", 282.4, 96.87737);
    } else { // not hasSeq
    }
    this.addButton(322, 82, 15.8, 10, 55, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 14));
    this.addButton(337.8, 82, 15.8, 10, 56, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 6));
    this.addButton(353.6, 82, 15.8, 10, 57, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 4));
    this.addButton(369.4, 82, 15.8, 10, 46, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 12));
    this.addButton(385.2, 82, 15.8, 10, 47, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 3));
    this.addButton(401, 82, 15.8, 10, 48, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 11));
    this.addButton(416.8, 82, 15.8, 10, 49, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 2));
    this.addButton(432.6, 82, 15.8, 10, 35, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 10));
    this.addButton(448.4, 82, 15.8, 10, 34, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 1));
    this.addButton(464.2, 82, 15.8, 10, 25, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 9));
    this.addUse("B_0", 322, 96.87737);
    this.addUse("B_1", 337.8, 96.87737);
    this.addUse("B_2", 353.6, 96.87737);
    this.addUse("B_3", 369.4, 96.87737);
    this.addUse("B_4", 385.2, 96.87737);
    this.addUse("B_5", 401, 96.87737);
    this.addUse("B_6", 416.8, 96.87737);
    this.addUse("B_7", 432.6, 96.87737);
    this.addUse("B_8", 448.4, 96.87737);
    this.addUse("B_9", 464.2, 96.87737);
    ...
    this.addButton(672.4, 82, 15.8, 10, 8, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 5));
    ...
    this.addDrawing(515.37596, 55.3, 3.37085, 5.12263,
      "0 0 3.37085 5.12263",
      [
        {
          tag: "path",
          attrs: {
            "d": "M 1 0.125 l 2.24585 0 -0.77001 3.62263 M 0 1.125 l 2.0333 0 -0.77001 3.62263",
            "fill": "none",
            "stroke": "#ffffff",
            "stroke-width": "0.25",
          }
    ...
    this.addDrawing(522.45233, 55.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
          attrs: {
            "d": "M 1 0.125 l 8.38781 0 -0.77001 3.62263 M 0 1.125 l 8.17526 0 -0.77001 3.62263",
            "fill": "none",
            "stroke": "#ffffff",
            "stroke-width": "0.25",
          }
    ...
    this.addDrawing(541.90513, 55.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(677.70513, 55.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(660.61336, 35.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(677.49392, 35.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(626.01116, 15.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(643.10293, 15.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(658.90293, 15.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(674.70293, 15.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    if (hasSeq) {
      this.addUse("B_tracks", 520.8, 74.00965);
      this.addRectangle(520.8, 75.47244, 10.42365, 0.25, Colors.WHITE);
      this.addRectangle(541.97635, 75.47244, 10.42365, 0.25, Colors.WHITE);
      this.addButton(520.8, 82, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      this.addUse("I_1_6", 520.8, 76.8);
      this.addButton(536.6, 82, 15.8, 10, 31, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 8));
      ...
      this.addDrawing(588.17187, 55.3, 8.09102, 5.12263,
        "0 0 8.09102 5.12263",
        [
          {
            tag: "path",
            attrs: {
              "d": "M 1 0.125 l 6.96602 0 -0.77001 3.62263 M 0 1.125 l 6.75347 0 -0.77001 3.62263",
              "fill": "none",
              "stroke": "#ffffff",
              "stroke-width": "0.25",
            }
      ...
      this.addDrawing(601.69581, 55.3, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(570.30325, 15.3, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(605.34233, 15.3, 6.81056, 5.12263,
        "0 0 6.81056 5.12263",
        [
          {
            tag: "path",
            attrs: {
              "d": "M 1 0.125 l 5.68556 0 -0.77001 3.62263 M 0 1.125 l 5.473 0 -0.77001 3.62263",
              "fill": "none",
              "stroke": "#ffffff",
              "stroke-width": "0.25",
            }
      ...
      this.addUse("B_edit", 565, 34.00965);
      this.addRectangle(565, 35.47244, 20.09213, 0.25, Colors.WHITE);
      this.addRectangle(592.30787, 35.47244, 20.09213, 0.25, Colors.WHITE);
      this.addUse("L_B_system", 565, 6.05893);
      this.addRectangle(565, 11, 58.5, 0.5, this.accentColor);
      this.addUse("L_B_sequencer", 565, 96.87737);
    } else { // not hasSeq
      this.addUse("B_multi", 520.8, 74.00965);
      this.addRectangle(520.8, 75.47244, 11.57926, 0.25, Colors.WHITE);
      this.addRectangle(540.82074, 75.47244, 11.57926, 0.25, Colors.WHITE);
      this.addButton(520.8, 82, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      ...
      this.addUse("L_B_system", 565, 96.87737);
    }
    ...
    this.addUse("L_B_performance", 505, 96.87737);
    this.addUse("L_B_programming", 625, 96.87737);
    ...
    this.addUse("L_I_cartridge", 720, 16.87737);
    ...
    this.addRectangle(477, -17.55893, 87, 0.25, Colors.WHITE);
    this.addUse("I_midi", 477, -22);
    this.addUse("L_I_thru", 480, -17.67263);
    this.addUse("L_I_out", 518, -17.67263);
    this.addUse("L_I_in", 558, -17.67263);
    this.addUse("L_I_ft_sw_", 640, -22);
    this.addUse("L_I_pedal_cv", 663, -22);
    if (hasSeq) {
      this.addRectangle(690, -17.55893, 38, 0.25, Colors.WHITE);
      this.addUse("L_I_left", 692, -22);
      this.addUse("L_I_right", 717, -22);
      this.addUse("I_mono", 690, -17.67263);
      this.addUse("I_aux_out", 690, -27.12263);
      this.addRectangle(740, -17.55893, 38, 0.25, Colors.WHITE);
      this.addUse("L_I_left", 742, -22);
      this.addUse("L_I_right", 767, -22);
      this.addUse("I_mono", 740, -17.67263);
      this.addUse("I_main_out", 740, -27.12263);
    } else { // not hasSeq
      this.addRectangle(740, -17.55893, 38, 0.25, Colors.WHITE);
      this.addUse("L_I_left", 742, -22);
      this.addUse("L_I_right", 767, -22);
    ...
    if (isSd1) {
      if (isSd132) {
        this.addDrawing(13, 67.35326, 67.00056, 37.14674,
          "0 0 67.00056 37.14674",
          [
            {
              tag: "path",
              attrs: {
        ...
        this.addDrawing(13, 76.2523, 67.0001, 28.2477,
          "0 0 67.0001 28.2477",
          [
            {
              tag: "path",
      ...
      if (hasSeq) {
        this.addDrawing(13, 78.49979, 90.49521, 26.00021,
          "0 0 90.49521 26.00021",
          [
            {
              tag: "path",
              attrs: {
        ...
        this.addDrawing(13, 71.50698, 92, 32.99302,
          "0 0 92 32.99302",
          [
            {
              tag: "path",
    ...
    if (hasSeq) {
      ...
      this.addLight(-56, 137.625, 5, 0.72222, 16);
    } else { // not hasSeq
    }
    ...
    this.addUse("L_I_patch", -91, 176.27737);
    this.addUse("L_I_select", -91, 179.87737);
    ...
    this.addUse("L_B_pitch", -92.5, 263.37737);
  ...
  populateCompactView(hasSeq, isSd1, isSd132) {
    ...
    this.addRectangle(-95, -11.94107, 578.2, 107.14107, Colors.PANEL);
    ...
    this.addUse("L_B_volume", -90, 83.87737);
    this.addUse("L_B_data_entry", -42.5, 83.87737);
    // Ending group 'Sliders'
    ...
    this.addButton(25, 69, 15.8, 10, 52, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 15));
    if (isSd1) {
      this.addUse("B_bankset", 25, 83.87737);
    } else { // not isSd1
      this.addUse("B_cart", 25, 83.87737);
    }
    this.addButton(40.8, 69, 15.8, 10, 53, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 13));
    this.addUse("B_sounds", 40.8, 83.87737);
    this.addButton(56.6, 69, 15.8, 10, 54, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 7));
    this.addUse("B_presets", 56.6, 83.87737);
    if (hasSeq) {
      this.addButton(72.4, 69, 15.8, 10, 51, Colors.BUTTON_LIGHT);
      this.addUse("B_seq", 72.4, 83.87737);
    } else { // not hasSeq
    }
    this.addButton(112, 69, 15.8, 10, 55, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 14));
    this.addButton(127.8, 69, 15.8, 10, 56, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 6));
    this.addButton(143.6, 69, 15.8, 10, 57, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 4));
    this.addButton(159.4, 69, 15.8, 10, 46, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 12));
    this.addButton(175.2, 69, 15.8, 10, 47, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 3));
    this.addButton(191, 69, 15.8, 10, 48, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 11));
    this.addButton(206.8, 69, 15.8, 10, 49, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 2));
    this.addButton(222.6, 69, 15.8, 10, 35, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 10));
    this.addButton(238.4, 69, 15.8, 10, 34, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 1));
    this.addButton(254.2, 69, 15.8, 10, 25, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 9));
    this.addUse("B_0", 112, 83.87737);
    this.addUse("B_1", 127.8, 83.87737);
    this.addUse("B_2", 143.6, 83.87737);
    this.addUse("B_3", 159.4, 83.87737);
    this.addUse("B_4", 175.2, 83.87737);
    this.addUse("B_5", 191, 83.87737);
    this.addUse("B_6", 206.8, 83.87737);
    this.addUse("B_7", 222.6, 83.87737);
    this.addUse("B_8", 238.4, 83.87737);
    this.addUse("B_9", 254.2, 83.87737);
    ...
    this.addButton(462.4, 69, 15.8, 10, 8, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 5));
    ...
    this.addDrawing(305.37596, 42.3, 3.37085, 5.12263,
      "0 0 3.37085 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(312.45233, 42.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(331.90513, 42.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(467.70513, 42.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(450.61336, 22.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(467.49392, 22.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(416.01116, 2.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(433.10293, 2.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(448.90293, 2.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(464.70293, 2.3, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    if (hasSeq) {
      this.addUse("B_tracks", 310.8, 61.00965);
      this.addRectangle(310.8, 62.47244, 10.42365, 0.25, Colors.WHITE);
      this.addRectangle(331.97635, 62.47244, 10.42365, 0.25, Colors.WHITE);
      this.addButton(310.8, 69, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      this.addUse("I_1_6", 310.8, 63.8);
      this.addButton(326.6, 69, 15.8, 10, 31, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 8));
      ...
      this.addDrawing(378.17187, 42.3, 8.09102, 5.12263,
        "0 0 8.09102 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(391.69581, 42.3, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(360.30325, 2.3, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(395.34233, 2.3, 6.81056, 5.12263,
        "0 0 6.81056 5.12263",
        [
          {
            tag: "path",
      ...
      this.addUse("B_edit", 355, 21.00965);
      this.addRectangle(355, 22.47244, 20.09213, 0.25, Colors.WHITE);
      this.addRectangle(382.30787, 22.47244, 20.09213, 0.25, Colors.WHITE);
      this.addUse("L_B_system", 355, -6.94107);
      this.addRectangle(355, -2, 58.5, 0.5, this.accentColor);
      this.addUse("L_B_sequencer", 355, 83.87737);
    } else { // not hasSeq
      this.addUse("B_multi", 310.8, 61.00965);
      this.addRectangle(310.8, 62.47244, 11.57926, 0.25, Colors.WHITE);
      this.addRectangle(330.82074, 62.47244, 11.57926, 0.25, Colors.WHITE);
      this.addButton(310.8, 69, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      ...
      this.addUse("L_B_system", 355, 83.87737);
    }
    ...
    this.addUse("L_B_performance", 295, 83.87737);
    this.addUse("L_B_programming", 415, 83.87737);
    // Ending group 'Buttons'
    ...
    this.addUse("L_I_patch", -64, 133.97737);
    this.addUse("L_I_select", -64, 137.57737);
    ...
    this.addUse("L_B_pitch", -75, 221.07737);
  ...
  populateTabletView(hasSeq, isSd1, isSd132) {
    ...
    this.addUse("L_B_volume", 0, 83.87737);
    ...
    this.addButton(30, 69, 15.8, 10, 52, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 15));
    if (isSd1) {
      this.addUse("B_bankset", 30, 83.87737);
    } else { // not isSd1
      this.addUse("B_cart", 30, 83.87737);
    }
    this.addButton(45.8, 69, 15.8, 10, 53, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 13));
    this.addUse("B_sounds", 45.8, 83.87737);
    this.addButton(61.6, 69, 15.8, 10, 54, Colors.BUTTON_LIGHT).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 7));
    this.addUse("B_presets", 61.6, 83.87737);
    if (hasSeq) {
      this.addButton(77.4, 69, 15.8, 10, 51, Colors.BUTTON_LIGHT);
      this.addUse("B_seq", 77.4, 83.87737);
    } else { // not hasSeq
    }
    this.addButton(117, 69, 15.8, 10, 55, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 14));
    this.addButton(132.8, 69, 15.8, 10, 56, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 6));
    this.addButton(148.6, 69, 15.8, 10, 57, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 4));
    this.addButton(164.4, 69, 15.8, 10, 46, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 12));
    this.addButton(180.2, 69, 15.8, 10, 47, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 3));
    this.addButton(196, 69, 15.8, 10, 48, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 11));
    this.addButton(211.8, 69, 15.8, 10, 49, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 2));
    this.addButton(227.6, 69, 15.8, 10, 35, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 10));
    this.addButton(243.4, 69, 15.8, 10, 34, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 1));
    this.addButton(259.2, 69, 15.8, 10, 25, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 9));
    this.addUse("B_0", 117, 83.87737);
    this.addUse("B_1", 132.8, 83.87737);
    this.addUse("B_2", 148.6, 83.87737);
    this.addUse("B_3", 164.4, 83.87737);
    this.addUse("B_4", 180.2, 83.87737);
    this.addUse("B_5", 196, 83.87737);
    this.addUse("B_6", 211.8, 83.87737);
    this.addUse("B_7", 227.6, 83.87737);
    this.addUse("B_8", 243.4, 83.87737);
    this.addUse("B_9", 259.2, 83.87737);
    ...
    this.addButton(259.2, 169.2, 15.8, 10, 8, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 5));
    ...
    this.addDrawing(102.17596, 142.5, 3.37085, 5.12263,
      "0 0 3.37085 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(109.25233, 142.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(128.70513, 142.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(264.50513, 142.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(247.41336, 122.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(264.29392, 122.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(212.81116, 102.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(229.90293, 102.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(245.70293, 102.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    this.addDrawing(261.50293, 102.5, 9.51281, 5.12263,
      "0 0 9.51281 5.12263",
      [
        {
          tag: "path",
    ...
    if (hasSeq) {
      this.addUse("B_tracks", 107.6, 161.20965);
      this.addRectangle(107.6, 162.67244, 10.42365, 0.25, Colors.WHITE);
      this.addRectangle(128.77635, 162.67244, 10.42365, 0.25, Colors.WHITE);
      this.addButton(107.6, 169.2, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      this.addUse("I_1_6", 107.6, 164);
      this.addButton(123.4, 169.2, 15.8, 10, 31, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 8));
      ...
      this.addDrawing(174.97187, 142.5, 8.09102, 5.12263,
        "0 0 8.09102 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(188.49581, 142.5, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(157.10325, 102.5, 9.51281, 5.12263,
        "0 0 9.51281 5.12263",
        [
          {
            tag: "path",
      ...
      this.addDrawing(192.14233, 102.5, 6.81056, 5.12263,
        "0 0 6.81056 5.12263",
        [
          {
            tag: "path",
      ...
      this.addUse("B_edit", 151.8, 121.20965);
      this.addRectangle(151.8, 122.67244, 20.09213, 0.25, Colors.WHITE);
      this.addRectangle(179.10787, 122.67244, 20.09213, 0.25, Colors.WHITE);
      this.addUse("L_B_system", 151.8, 93.25893);
      this.addRectangle(151.8, 98.2, 58.5, 0.5, this.accentColor);
      this.addUse("L_B_sequencer", 151.8, 184.07737);
    } else { // not hasSeq
      this.addUse("B_multi", 107.6, 161.20965);
      this.addRectangle(107.6, 162.67244, 11.57926, 0.25, Colors.WHITE);
      this.addRectangle(127.62074, 162.67244, 11.57926, 0.25, Colors.WHITE);
      this.addButton(107.6, 169.2, 15.8, 10, 30, Colors.BUTTON_MEDIUM).addLight(this.addLight(5.26667, 0.4, 5.26667, 3.33333, 0));
      ...
      this.addUse("L_B_system", 151.8, 184.07737);
    }
    ...
    this.addUse("L_B_data_entry", 32, 184.07737);
